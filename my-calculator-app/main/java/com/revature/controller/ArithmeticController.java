...
public class ArithmeticController {
	...
	public Handler subtract = (ctx) -> {		//controller level method for subtraction
	...
	public Handler divide = (ctx) -> {		//controller level method for subtraction
		
		ctx.result("division lambda invoked");
